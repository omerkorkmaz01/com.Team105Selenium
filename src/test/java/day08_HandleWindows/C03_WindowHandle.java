...
import org.openqa.selenium.devtools.v104.page.model.AdFrameExplanation;
...
public class C03_WindowHandle {
    ...
    public void test01() throws InterruptedException {
        ...
        // click yapmadan once ilk sayfanin
        String ilkSayfaWHD= driver.getWindowHandle();
        driver.findElement(By.linkText("Elemental Selenium")).click();
        // click yapinca yeni tab acilir ancak driver eski tab'da kalir
        // yeni tab'a driver'i gecirmek icin yeni tab'in WHD tab'da kalir
        ...
        // doreach loop bitiginde ikinci sayfanin WHD'ini elde etmis olacagiz
        // bu degeri kullanarak, driver'i 2.sayfaya gecirebbiliriz
        driver.switchTo().window(ikinciSayfaWHD);
        // yeni tab'a gecip sayfadaki en buyuk yazinin "Elemental Selenium" oldugunu test edin
        String exceptedIkinciSayfaYazi="Elemental Selenium";
        String actualIkinciSayfaYazi= driver.findElement(By.tagName("h1")).getText();

        Assert.assertEquals(exceptedIkinciSayfaYazi,actualIkinciSayfaYazi);
        // ilk sayfaya geri donup sayfadaki yazinin
        // "An iFrame containing the TinyMCE WYSIWYG Editor" oldugunu test edin
        driver.switchTo().window(ilkSayfaWHD);

        String exceptedIlkSayfaYazi="An iFrame containing the TinyMCE WYSIWYG Editor";
        String actualIlkSayfaYazi=driver.findElement(By.tagName("h3")).getText();

        Assert.assertEquals(exceptedIlkSayfaYazi,actualIlkSayfaYazi);
